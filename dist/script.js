...
function purchaseResult(sum) {
    if (200 <= sum && sum < 300) {
        console.log('К оплате со скидкой 3% ' + (sum * 0.97));
    }
    else if (300 <= sum && sum < 500) {
        console.log('К оплате со скидкой 5%:  ' + (sum * 0.95));
    }
    else if (500 <= sum) {
        console.log('К оплате со скидкой 7%:  ' + (sum * 0.93));
    }
    else {
        console.log('К оплатe без скидки  ' + sum);
    }
}
console.log(purchaseResult(300));
...
function define(circumference, perimeter) {
